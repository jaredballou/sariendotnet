 ...
 * @version 0.00.00.01
 */
public class ExpressionEqual extends ExpressionBi
{
    /**
     ...
     */
    public ExpressionEqual(Context context, InputStream stream, LogicReader reader, short bytecode) throws IOException
    {
