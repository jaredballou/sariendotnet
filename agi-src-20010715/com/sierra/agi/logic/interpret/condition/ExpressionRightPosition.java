 ...
 * @version 0.00.00.01
 */
public class ExpressionRightPosition extends ExpressionPent
{
    /**
     ...
     */
    public ExpressionRightPosition(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
