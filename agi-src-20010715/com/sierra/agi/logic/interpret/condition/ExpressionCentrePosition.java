 ...
 * @version 0.00.00.01
 */
public class ExpressionCentrePosition extends ExpressionPent
{
    /**
     ...
     */
    public ExpressionCentrePosition(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
