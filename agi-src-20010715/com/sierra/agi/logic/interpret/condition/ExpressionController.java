 ...
 * @version 0.00.00.01
 */
public class ExpressionController extends ExpressionUni
{
    /**
     ...
     */
    public ExpressionController(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
