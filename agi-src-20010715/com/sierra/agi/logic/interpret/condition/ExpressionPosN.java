 ...
 * @version 0.00.00.01
 */
public class ExpressionPosN extends ExpressionPent
{
    /**
     ...
     */
    public ExpressionPosN(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
