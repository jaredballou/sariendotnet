 ...
 * @version 0.00.00.01
 */
public class ExpressionLess extends ExpressionBi
{
    /**
     ...
     */
    public ExpressionLess(Context context, InputStream stream, LogicReader reader, short bytecode) throws IOException
    {
