...
/**
 * Base Class for all Logic's Instructions that has 5 parameters.
 *
 * @author  Dr. Z
 * @version 0.00.00.01
 */
public abstract class ExpressionPent extends Expression
{
     ...
     */
    protected ExpressionPent(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
