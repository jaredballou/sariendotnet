 ...
 * @version 0.00.00.01
 */
public class InstructionAcceptInput extends Instruction
{
    /** 
     ...
     */
    public InstructionAcceptInput(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
