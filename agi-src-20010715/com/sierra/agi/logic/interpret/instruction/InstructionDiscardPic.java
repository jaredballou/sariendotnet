...
public class InstructionDiscardPic extends InstructionUni
{
     ...
     */
    public InstructionDiscardPic(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.context.cache.unloadPicture(logicContext.vars[p1]);
        return 2;
    }
