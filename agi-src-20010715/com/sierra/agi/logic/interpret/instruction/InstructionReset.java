 ...
 * @version 0.00.00.01
 */
public class InstructionReset extends InstructionUni
{
    /** 
     ...
     */
    public InstructionReset(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
