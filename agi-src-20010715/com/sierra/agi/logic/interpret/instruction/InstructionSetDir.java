...
public class InstructionSetDir extends InstructionBi
{
     ...
     */
    public InstructionSetDir(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.viewTable.getViewTableEntry(p1).setDirection(logicContext.vars[p2]);
        return 3;
    }
