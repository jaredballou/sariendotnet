...
public class InstructionGetDir extends InstructionBi
{
     ...
     */
    public InstructionGetDir(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.setVar(p2, logicContext.viewTable.getViewTableEntry(p1).getDirection());
        return 3;
    }
