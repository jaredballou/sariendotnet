...
public class InstructionGetPriority extends InstructionBi
{
     ...
     */
    public InstructionGetPriority(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.setVar(p2, logicContext.viewTable.getViewTableEntry(p1).getPriority());
        return 3;
    }
