...
public class InstructionCurrentCell extends InstructionBi
{
     ...
     */
    public InstructionCurrentCell(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.setVar(p2, logicContext.viewTable.getViewTableEntry(p1).getCurrentCell());
        return 3;
    }
