 ...
 * @version 0.00.00.01
 */
public class InstructionSubmitMenu extends Instruction
{
    /** 
     ...
     */
    public InstructionSubmitMenu(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
