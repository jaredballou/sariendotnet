 ...
 * @version 0.00.00.01
 */
public class InstructionLoadPic extends InstructionUni
{
    /** 
     ...
     */
    public InstructionLoadPic(Context context,InputStream stream,LogicReader reader,short bytecode) throws IOException
    {
    ...
    {
        logicContext.context.cache.loadPicture(logicContext.vars[p1]);
        return 2;
    }
